  ...
  Future<dynamic> getFormattedChat(
    ...
    return CactusNative.getFormattedChat(
      ...
      tmpl,
      {
        ...
        'parallel_tool_calls':
            parallelToolCalls != null ? jsonEncode(parallelToolCalls) : null,
    ...
    if (params.messages != null) {
      ...
      if (formattedResult is JinjaFormattedChatResult) {
        ...
        if (formattedResult.grammarTriggers != null) {
          nativeParams['grammar_triggers'] =
              formattedResult.grammarTriggers?.map((t) => t.toJson()).toList();
        }
        if (formattedResult.preservedTokens != null) {
          nativeParams['preserved_tokens'] = formattedResult.preservedTokens;
        }
        if (formattedResult.additionalStops != null &&
            formattedResult.additionalStops!.isNotEmpty) {
        ...
        if (event['contextId'] == id) {
          final tokenData = TokenData(
            ...
            completionProbabilities:
                event['tokenResult']['completion_probabilities'] != null
                    ? List<TokenProb>.from((event['tokenResult']
                            ['completion_probabilities'] as List)
